...
const Contact = () => {
  ...
  const contactEmail =
    personalInfo?.emails?.primary || 'Samprit.code@gmail.com';

  // EmailJS is "ready" only when real keys are configured (not the placeholder).
  const emailjsReady =
  ...
  const handleSubmit = (event) => {
    ...
    /* -----------------------------------------------------------------
       Path A: EmailJS configured → send via EmailJS
       (must create a free EmailJS account + .env keys to enable)
    ----------------------------------------------------------------- */
    if (emailjsReady) {
      emailjs
        .send(
    ...
    /* -----------------------------------------------------------------
       Path B (works right now, no signup): FormSubmit.co
       Sends the message straight to your inbox. On first ever submit,
       FormSubmit emails your inbox and asks you to confirm — click it
       once and every message after that arrives automatically.
    ----------------------------------------------------------------- */
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            >
              ...
              <span>
                SAMPRIT / AVAILABLE FOR NEW PROJECTS
              </span>
            </div>
              ...
              >
                ...
                {sent && (
                  <p className="text-sm font-bold text-emerald-600">
                    ✓ Thanks, your message was sent successfully! I'll get back
                    to you soon.
                  </p>
                )}
                {error && (
        ...
        <div
          ...
          "
        >
          <span>SAMPRIT / PORTFOLIO</span>

          <span>
            © {new Date().getFullYear()} SAMPRIT
          </span>
        </div>
      </div>
