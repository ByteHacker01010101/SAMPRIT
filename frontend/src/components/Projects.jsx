    ...
    <div className="flex flex-1 flex-col p-6 md:p-7">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        {project.links.github && (
          <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2.5 text-xs font-bold text-white transition hover:bg-amber-700"><ExternalLinkIcon />Source Code</a>
        )}
        {project.links.demo && (
